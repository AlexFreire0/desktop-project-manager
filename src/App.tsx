  ...
  return (
    <div className="app-shell">
      ...
      <main className="main-content">
        ...
        {view === 'projects' && selected && <ProjectDrawer project={selected} settings={data.settings} onClose={() => setSelectedId(undefined)} onEdit={() => setProjectDialog(selected)} onSave={saveProject} onNotice={showNotice} />}
